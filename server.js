...
Mọi thắc mắc về tình trạng chốt hoặc nhận BHXH, vui lòng liên hệ Phòng Nhân sự (C&B) trong giờ hành chính và cung cấp họ tên, số CCCD hoặc mã nhân viên để được hỗ trợ."
`.trim();
